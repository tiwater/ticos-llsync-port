...
#define BLE_QIOT_LLSYNC_STANDARD    0   // support llsync standard
    ...
    #define BLE_QIOT_RECORD_FLASH_ADDR 0x27000
    ...
    #define BLE_QIOT_SUPPORT_OTA 1  // 1 is support ota, others not
        ...
        #define BLE_QIOT_SUPPORT_RESUMING 1  // 1 is support resuming, others not
            ...
            #define BLE_QIOT_OTA_INFO_FLASH_ADDR (BLE_QIOT_RECORD_FLASH_ADDR + BLE_QIOT_RECORD_FLASH_PAGESIZE)
        #endif  // BLE_QIOT_SUPPORT_RESUMING

        #define BLE_QIOT_TOTAL_PACKAGES 0xFF  // the total package numbers in a loop
        #define BLE_QIOT_PACKAGE_LENGTH 0xF0  // the user data length in package, MAX: ble_get_user_data_mtu_size() - 6
