...
int tecent_ll_task_init(void)
{
    ...
    u32 malloc_size = (ble_get_user_data_mtu_size(ble_system_type_get()) + LL_PACKET_HEAD_LEN) * BLE_QIOT_TOTAL_PACKAGES;
    ...
    os_task_create(tecent_ll_task, NULL, 31, 1024, 0, "tecent_ll_task");
    return 0;
}
